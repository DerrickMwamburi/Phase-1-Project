document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://phase-1-project-fygn.onrender.com/agencies")
        .then(response => response.json())
        .then(agencies => {
    ...
    function loadBookings() {
        fetch("https://phase-1-project-fygn.onrender.com/bookings")
            .then(response => response.json())
            .then(bookings => {
    ...
    function deleteBooking(id) {
        fetch(`https://phase-1-project-fygn.onrender.com/bookings/${id}`, {
            method: "DELETE"
        })
